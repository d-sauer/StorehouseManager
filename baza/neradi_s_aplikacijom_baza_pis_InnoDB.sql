...
CREATE SCHEMA IF NOT EXISTS `purgardb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `purgardb`;

-- -----------------------------------------------------
-- Table `purgardb`.`vrPartnera`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `purgardb`.`vrPartnera` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `purgardb`.`partner` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `purgardb`.`ponuda` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `purgardb`.`stavkaPonuda` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `purgardb`.`racun` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `purgardb`.`zaposlenici` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `purgardb`.`otpremnica` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `purgardb`.`stavkaOtpremnice` ;
